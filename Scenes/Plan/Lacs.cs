    ...
    public class Lacs
    {
        ...
        public static List<(int, int)> GenerateLac(PlanInitial _planInitial)
        {
            ...
            for (int i = 0; i < nbr_flaque_eau; i++)
            {
                ...
                ) //Si tous les blocs au tour sont des blocs terre ou eau alors on commence a creer le lac
                {
                    coordonnes_base_flaques.Add((rand_x, rand_y));

                    int nbr_block_eau = rand.Next(Ref_donnees.min_block_flaque_eau,
                        Ref_donnees.max_block_flaque_eau + 1);
                        ...
                        switch (deplacement)
                        {
                            case 0:
                            {
                                ...
                                if (Valid_Position(rand_x, rand_y, _planInitial))
                                {
                                    ...
                                    {
                                        _planInitial.SetBlock(_planInitial.TileMap1, rand_x + 1, rand_y,
                                            Ref_donnees.eau);
                                        j++;
                                    }
                                    ...
                                    {
                                        _planInitial.SetBlock(_planInitial.TileMap1, rand_x, rand_y + 1,
                                            Ref_donnees.eau);
                                        j++;
                                    }
