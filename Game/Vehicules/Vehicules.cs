...
namespace SshCity.Game.Vehicules
{
    public partial class Vehicules : Area2D
    {
        ...
        /// </summary>
        Godot.Collections.Dictionary<Type, SpriteFrames> AnimatedSpriteType =
            new Godot.Collections.Dictionary<Type, SpriteFrames>()
            {
                {
                    Type.AMBULANCE,
                    ResourceLoader.Load("res://Game/Vehicules/ANimatedSpriteVehicules/Ambulance_animatedSprite.tres") as
                        SpriteFrames
                },
                {
                    Type.CAMION,
                    ResourceLoader.Load("res://Game/Vehicules/ANimatedSpriteVehicules/Camion_animatedSprite.tres") as
                        SpriteFrames
                },
                {
                    Type.VOITURE,
                    ResourceLoader.Load("res://Game/Vehicules/ANimatedSpriteVehicules/Voiture_animatedSprite.tres") as
                        SpriteFrames
                },
                {
                    Type.POLICE,
                    ResourceLoader.Load("res://Game/Vehicules/ANimatedSpriteVehicules/Police_animatedSprite.tres") as
                        SpriteFrames
                },
                {
                    Type.SPORTIVE,
                    ResourceLoader.Load("res://Game/Vehicules/ANimatedSpriteVehicules/VoitureSport_animatedSprite.tres")
                        as SpriteFrames
                },
                {
                    Type.LUXE,
                    ResourceLoader.Load("res://Game/Vehicules/ANimatedSpriteVehicules/Luxe_animatedSprite.tres") as
                        SpriteFrames
                },
                {
                    Type.SUV,
                    ResourceLoader.Load("res://Game/Vehicules/ANimatedSpriteVehicules/SUV_animatedSprite.tres") as
                        SpriteFrames
                },
                {
                    Type.LIVRAISON,
                    ResourceLoader.Load("res://Game/Vehicules/ANimatedSpriteVehicules/Livraison_animatedSprite.tres") as
                        SpriteFrames
                },
                {
                    Type.HATCHBACK,
                    ResourceLoader.Load("res://Game/Vehicules/ANimatedSpriteVehicules/HatchBack_animatedSprite.tres") as
                        SpriteFrames
                },
                {
                    Type.VOITURECOURSE,
                    ResourceLoader.Load(
                            "res://Game/Vehicules/ANimatedSpriteVehicules/VoitureCourse_animatedSprite.tres") as
                        SpriteFrames
                },
                {
                    Type.TAXI,
                    ResourceLoader.Load("res://Game/Vehicules/ANimatedSpriteVehicules/Taxi_animatedSprite.tres") as
                        SpriteFrames
                },
                {
                    Type.TRACTEURPOLICE,
                    ResourceLoader.Load(
                            "res://Game/Vehicules/ANimatedSpriteVehicules/TracteurPolice_animatedSprite.tres") as
                        SpriteFrames
                },
                {
                    Type.TRACTOPEL,
                    ResourceLoader.Load("res://Game/Vehicules/ANimatedSpriteVehicules/Tractopel_animatedSprite.tres") as
                        SpriteFrames
                },
                {
                    Type.TRACTEUR,
                    ResourceLoader.Load("res://Game/Vehicules/ANimatedSpriteVehicules/Tracteur_animatedSprite.tres") as
                        SpriteFrames
                },
                {
                    Type.VOITURETRUCK,
                    ResourceLoader.Load("res://Game/Vehicules/ANimatedSpriteVehicules/VoitureTruck_animatedSprite.tres")
                        as SpriteFrames
                },
                {
                    Type.VAN,
                    ResourceLoader.Load("res://Game/Vehicules/ANimatedSpriteVehicules/Van_animatedSprite.tres") as
                        SpriteFrames
                },
            };
        ...
        /// </summary>
        Godot.Collections.Dictionary<string, Vector2> DecallageDico =
        ...
        public void Init(PlanInitial planInitial, Vector2 position, Type type, bool autonome = false)
        {
            ...
            SpriteFrames
                spriteFrames =
                    AnimatedSpriteType[
                        type]; //Charge l'animatedSprite, donc l'image du vehicule, en fonction du type rentre en parametre
            _animatedSprite.Frames = spriteFrames; //Set l'animatedSprite
            int blocRoute =
                planInitial.GetBlock(planInitial.TileMap2, (int) position.x,
                    (int) position.y); //Recupere l'index du bloc route sur le quel est le vehicule
            _animatedSprite.Animation = WhichAnimation[blocRoute]; //Set l'animation en fonction du bloc route
            Decallage = DecallageDico[
                _animatedSprite
                    .Animation]; //Decallage du vehicule en fonction de l'animation pour qu'il soit centre sur la route
            _collisionShape2D.Rotation =
                CollisionAngle
                    [_animatedSprite.Animation]; // Rotation du CollisionShape2D en fonction de l'anmation pour qu'il soit centré sur le vehicule
            ...
            this.Position =
                planInitial.TileMap2.MapToWorld(position + new Vector2(1, 1)) +
                Decallage; //Set la position du vehicule. LE new Vector2(1, 1) correspond au decallage du tileset
        ...
        public void Collision(Area2D area2D)
        {
            ...
            else if (!_stopArea2DCreat && !_stopAccident && _type != Type.AMBULANCE && _type != Type.POLICE &&
                     _type != Type.CAMION)
            {
        ...
        {
            if (area2D.CollisionMask == 7 && _type != Type.AMBULANCE && _type != Type.POLICE && _type != Type.CAMION
            ) //Tets si l'area2D est une area2D Accident
            {
